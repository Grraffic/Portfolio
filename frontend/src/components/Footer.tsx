...
const Footer = () => {
  ...
  return (
    <footer className="bg-white dark:bg-navy-900 border-t border-slate-200 dark:border-navy-700 py-10 mt-20 transition-colors duration-200">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          {/* Copyright */}
          <p className="text-slate-400 dark:text-slate-500 text-xs transition-colors duration-200">
